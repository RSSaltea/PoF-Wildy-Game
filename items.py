...
ITEMS: Dict[str, Dict[str, Any]] = {
    ...
    # Range Weapons
    "Rotwood shortbow": {"type": "mainhand", "style": "range", "stance": "range", "str_range": 12, "consumes": "Bronze arrows", "stackable": False, "value": 5000, "aliases": "rotwood bow,rotwood"},
    "Whisperwood bow": {"type": "mainhand", "style": "range", "stance": "range", "str_range": 20, "consumes": "Iron arrows", "stackable": False, "value": 15000, "aliases": "whisperwood,wbow"},
    "Ironwood bow": {"type": "mainhand", "style": "range", "stance": "range", "str_range": 32, "consumes": "Mithril arrows", "stackable": False, "value": 35000, "aliases": "ironwood,ibow"},
    "Hexwood bow": {"type": "mainhand", "style": "range", "stance": "range", "str_range": 48, "consumes": "Adamant arrows", "stackable": False, "value": 55000, "aliases": "hexwood,hbow"},
    "Bone crossbow": {"type": "mainhand", "style": "range", "stance": "range", "str_range": 56, "consumes": "Bone bolts", "stackable": False, "value": 70000, "aliases": "bone xbow,bone cbow,bcbow"},
    "Nightfall bow": {"type": "mainhand,offhand", "style": "range", "stance": "range", "str_range": 88, "consumes": "Dragon arrows", "stackable": False, "value": 120000, "aliases": "nightfall,nbow"},
    ...
    # Arrows (ammo)
    "Bronze arrows": {"type": "ammo", "stackable": True, "value": 10, "aliases": "bronze arrow,bronze arrows"},
    "Iron arrows": {"type": "ammo", "stackable": True, "value": 25, "aliases": "iron arrow,iron arrows"},
    "Steel arrows": {"type": "ammo", "stackable": True, "value": 50, "aliases": "steel arrow,steel arrows"},
    "Mithril arrows": {"type": "ammo", "stackable": True, "value": 100, "aliases": "mithril arrow,mithril arrows,mith arrows"},
    "Adamant arrows": {"type": "ammo", "stackable": True, "value": 200, "aliases": "adamant arrow,adamant arrows,addy arrows"},
    "Rune arrows": {"type": "ammo", "stackable": True, "value": 400, "aliases": "rune arrow,rune arrows"},
    "Dragon arrows": {"type": "ammo", "stackable": True, "value": 800, "aliases": "dragon arrow,dragon arrows,d arrows"},
    "Bone bolts": {"type": "ammo", "stackable": True, "value": 600, "aliases": "bone bolt,bone bolts,bbolts"},
...
ITEM_EFFECTS = {
    ...
    # Range weapons
    "Rotwood shortbow": {"effect": "Fires Bronze arrows. 20% chance to consume 1 arrow per hit."},
    "Whisperwood bow": {"effect": "Fires Iron arrows. 20% chance to consume 1 arrow per hit."},
    "Ironwood bow": {"effect": "Fires Mithril arrows. 20% chance to consume 1 arrow per hit."},
    "Hexwood bow": {"effect": "Fires Adamant arrows. 20% chance to consume 1 arrow per hit."},
    "Bone crossbow": {"effect": "Fires Bone bolts. 20% chance to consume 1 bolt per hit."},
    "Nightfall bow": {"effect": "A devastating two-handed range weapon. Fires Dragon arrows. 20% chance to consume 1 arrow per hit."},
    # Magic weapons
