...
# Local copies of wilderness-level constants used by combat logic
    ...
    def simulate_pvm_fight_and_loot(
        ...
        *,
        ...
        if your_hp <= 0:
            ...
            events.extend(self.food_summary_lines(eaten_food, p.inventory))
        ...
        loot_lines.extend(self.food_summary_lines(eaten_food, p.inventory))
