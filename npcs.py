...
NPCS: List[Dict[str, Any]] = [
    ...
    {"name": "Revenant knight", "hp": 50, "tier": 2, "min_wildy": 10, "npc_type": "revenant knight",
     "atk": 5, "def": 3, "slayer_level": 10, "slayer_xp": 30, "task_range": [15, 30],
